...
const ForgetPassword = () => {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      const response = await axios.post(
        'https://restaurant-website-dusky-one.vercel.app/user/otpPassword',
        { email }
      );
  ...
  const handleChangePassword = async () => {
    ...
    try {
      const response = await axios.post(
        'https://restaurant-website-dusky-one.vercel.app/user/forgetPassword',
      ...
      <div className="w-full max-w-md mx-auto bg-white shadow-md rounded-lg p-6">
        {isLoading || isOtpResending ? (
          ...
          <>
                ...
                <form onSubmit={(e) => { e.preventDefault(); handleChangePassword(); }}>
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      required
                    />
                    {newPasswordError && <p className="text-red-500 text-sm mb-2">{newPasswordError}</p>} 
                  </div>
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      required
                    />
                    {confirmPasswordError && <p className="text-red-500 text-sm mb-2">{confirmPasswordError}</p>} 
                  </div>
                  <button
                    type="submit"
                    className="w-full bg-orange-500 text-white p-2 rounded mt-4 hover:bg-orange-600"
            ...
            {step === 3  && (
              <div>
                <p className="text-center text-green-500">{successMessageDisplayed}</p>
              </div>
            )}
          </>
        )}
